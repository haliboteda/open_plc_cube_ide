...
★ **OW1 当场抓到"认领曾经是安全剧场"** —— 验签写死了公开密钥，认领之后照样能用出厂密钥烧固件。**除了这条用例，没有任何东西会发现** —— 其他每个症状看起来都完全正确。已修。
...
| — | **E3** bootloader 镜像尺寸 | 当前 **96,944 B**，上限 **122,880 B**（120K，尾部 8K 划给 owner 记录区），余量 **21%** |
