...
| `P1`–`P9` | **静态检查**（P1–P6 看代码，P7–P9 看文档）| `$TOOL:TestTool/TEST-CASES.md` | `tools/check_version_sync.py`(P1)、`check_mirror_sync.py`(P2)、`check_core_sync.py`(P3)、`host/variant_check/build.py`(P4)、`host/examples_build/build.py`(P5)、`check_public_root.py`(P6)、`check_status_sync.py`(P7)、`check_doc_dupes.py`(P8)、`check_doc_paths.py`(P9) | [test/MEASUREMENTS.md](test/MEASUREMENTS.md) |
