...
bootloader 镜像 **96,944 B**（`Debug/`，-O0，**已含 FMC**）/ 扇区 131,072 B，可用上界 122,880 B。⚠️ **数字的唯一出处是 [../test/MEASUREMENTS.md](../test/MEASUREMENTS.md)** —— 这里以前写的 96,388 B 是更早一次构建的值，2026-08-22 统一。
