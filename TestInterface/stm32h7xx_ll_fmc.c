...
/* Vendor file copied in for the standalone SDRAM bring-up test in this same
   TestInterface folder (this project's Core/stm32h7xx_hal_conf.h never
   enabled HAL_SDRAM_MODULE_ENABLED, and we don't want to touch CubeMX-owned
