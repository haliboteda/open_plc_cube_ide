...
/* Vendor file copied in for the standalone DAC bring-up test in this same
   TestCase folder (this project's Core/stm32h7xx_hal_conf.h never
   enabled HAL_DAC_MODULE_ENABLED, and we don't want to touch CubeMX-owned
